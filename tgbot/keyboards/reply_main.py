...
def payments_frep():
    ...
    #keyboard.row("💰 Изменить Binance 🖍","💰 Изменить USDT 🖍")
    #keyboard.row(,"💰 Проверить кошельки 👁")
    keyboard.row("💰 Изменить Binance 🖍","💰 Проверить Binance ♻", "💰 Баланс Binance 👁")
    keyboard.row("💰 Изменить USDT 🖍")
